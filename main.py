...
smtp_username = "username@gmail.com" # This is the username used to login to your SMTP provider
...
smptObj = smtplib.SMTP_SSL(smtp_host, smtp_port)

smtp_sender = "username@gmail.com"  # This is the FROM email address
smtp_receivers = ['username@email.com'] # This is the TO email address
...
#to let us know when the pin goes HIGH or LOW
